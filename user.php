            ...
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"><i
                            class="bi bi-person-add"></i> Tambah User</button>
                </div>
            </div>
            <!-- Modal Tambah User -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="col-lg-12">
                                        <?php 
                                        if($row['username'] == $_SESSION['username_selera']){
                                            echo "<div class='alert alert-danger'>Anda tidak dapat menghapus akun sendiri</div>";
                                        }else {
                                            echo "Apakan anda yakin ingin menghapus user <b>$row[username]</b>";
                                        }
                                        ?>
                                    </div>
                                    <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger" name="input_user_validate"
                                        value="1234" <?php echo ($row['username'] == $_SESSION['username_selera']) ? 'disabled' : '' ; ?>>Hapus</button>
                                </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if($row['username'] == $_SESSION['username_selera']){
                                            ...
                                            echo "Apakan anda yakin ingin mereset password user <b>$row[username]</b> menjadi password bawaan sistem <b>123</b>";
                                        }
                                        ?>
                                    </div>
                                    <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="input_user_validate"
                                        value="1234" <?php echo ($row['username'] == $_SESSION['username_selera']) ? 'disabled' : '' ; ?>>Reset Password</button>
                                </div>
                                </form>
                            </div>
                        </div>
